    ...
    <div class="min-h-[80vh] flex flex-col justify-center items-center px-4 py-12">
        ...
        <div class="w-full max-w-2xl bg-white p-8 border border-gray-200 rounded-2xl shadow-sm">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Update Job</h1>
            ...
            <form action="{{ route('listings.update', [$listing]) }}" method="POST" class="space-y-6"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="tags" placeholder="php, laravel, javascript" value="{{ old('tags', $listing->tags) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="company_name" id="company_name" value="{{ old('company_name', $listing->company_name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location', $listing->location) }}" placeholder="e.g. Remote or NY"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none">
                        @error('location')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="salary" id="salary" value="{{ old('salary', $listing->salary) }}" placeholder="e.g. $80k - $100k"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                    ...
                    <div>
                        ...
                        <input type="url" name="website" id="website" value="{{ old('website', $listing->website) }}"
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $listing->email) }}" placeholder="example@gmail.com"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition @error('website') border-red-500 @enderror">
                        @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        @if($listing->logo)
                        <img src="{{ asset('storage/' . $listing->logo) }}" class="w-20 h-20 rounded-full border-2 border-white shadow-sm object-cover">

                        <div class="flex flex-col gap-1">
                            <span class="text-sm font-medium text-gray-900">Logo is uploaded</span>
                            <label class="text-xs text-blue-600 font-semibold cursor-pointer hover:text-blue-800">
                                Change Logo
            ...
            hover:file:bg-blue-100 cursor-pointer">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="5"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                            focus:ring-2 focus:ring-blue-500 outline-none">{{ old('description', $listing->description) }}</textarea>
